...
BEGIN
  ...
  SELECT 
    CASE WHEN cos_status = 'Rejected' THEN true ELSE false END,
    true
  INTO cos_rejected, has_active_cos
  ...
  -- 2. Invalid/rejected documents
  IF rtw_invalid OR cos_rejected THEN
...
-- Update all existing employee immigration statuses
UPDATE public.employees 
