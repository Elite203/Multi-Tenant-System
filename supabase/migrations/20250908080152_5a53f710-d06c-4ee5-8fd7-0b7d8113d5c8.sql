-- Enable the pgcrypto extension for digest function
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Fix the document hash function with proper type casting
...
AS $function$
  SELECT encode(digest(file_content, 'sha256'::text), 'hex');
$function$;
