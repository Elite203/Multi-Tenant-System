-- First, update the employee_complete_view to remove national_insurance_number reference
...
SELECT 
  ...
  -- Work profile information (excluding national_insurance_number)
  wp.soc_number,
  wp.work_email,
  wp.work_phone,
  wp.work_location,
  wp.weekly_working_hours,
  wp.work_sponsored_by_company_id,
  wp.skills,
  wp.languages,
  wp.work_preferences,
  wp.career_goals,
...
-- Now remove the national_insurance_number column from employee_work_profiles table
