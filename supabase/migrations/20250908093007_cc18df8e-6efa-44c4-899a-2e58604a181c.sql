-- Update companies import template to use parent company name lookup
...
SET 
  ...
  optional_fields = ARRAY['company_code', 'parent_company_name', 'email', 'phone', 'street_address', 'city', 'state_province', 'postal_code', 'country_id', 'website', 'registration_number', 'tax_number', 'description', 'has_sponsor_license'],
  updated_at = now()
